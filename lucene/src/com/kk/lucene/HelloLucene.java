...
/**
 * @author Johnny
 * @description: 依赖jar:Lucene-core，Lucene-analysis（使用标准分词器做测试），Lucene-queryParser
 * 作用：简单的索引建立和读取步骤
 * <p/>
...
public class HelloLucene {
    ...
    private static final String FILES = "D:\\workspace\\idea\\lucene-data\\hellolucene\\files";
    private static final String INDEX = "D:\\workspace\\idea\\lucene-data\\hellolucene\\index";
...
//        createIndex();
    ...
    public static void createIndex() {
        ...
        try {
            ...
            Directory directory = FSDirectory.open(new File(INDEX));//在硬盘上生成Directory
            //2、创建IndexWriter
